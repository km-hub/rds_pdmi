...
variable "identifier" {
  ...
  default = "pdmi-data-warehouse-prod-instance-1"
}
...
variable "vpc_security_group_ids" {
  ...
  type        = list(string)
  default     = ["Talend RDS (sg-0fe97ba88ac9539c6)"]
}
...
variable "option_group_name" {
  ...
  type        = string
  default     = "default:aurora-mysql-5-7"
}
